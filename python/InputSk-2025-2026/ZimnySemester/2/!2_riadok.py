'''
Napíš funkciu riadok(n, text=''), ktorá vypíše n znakový reťazec hviezdičiek '*', stred ktorého nahradí zadaným textom. Ak je tento zadaný text neprázdny, vloží na jeho začiatok aj koniec medzeru. Napríklad pre volania:
